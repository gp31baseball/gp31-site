...
export default function Roster() {
  const roster = [
    ...
    { number: 88, name: "Hunter", position: "C / 1B", batsThrows: "R/R", image: "/gallery/hunter.jpg" },
    { number: 2, name: "Nate", position: "2B / OF / RHP", batsThrows: "R/R", image: "/gallery/nate.jpg" },
    { number: 3, name: "Luis", position: "OF / RHP", batsThrows: "R/R", image: "/gallery/luis.jpg" },
    { number: 99, name: "Bruno", position: "C / RHP", batsThrows: "L/R", image: "/gallery/bruno.jpg" },
    { number: 8, name: "Ryland", position: "MIF / RHP", batsThrows: "R/R", image: "/gallery/ryland.jpg" },
    { number: 32, name: "Matt", position: "OF", batsThrows: "R/R", image: "/gallery/matt.jpg" },
    { number: 24, name: "Juan", position: "1B / OF", batsThrows: "R/R", image: "/gallery/juan.jpg" },
    { number: 1, name: "Josiah", position: "1B / RHP", batsThrows: "R/R", image: "/gallery/josiah.jpg" },
    { number: 0, name: "Chulo", position: "MIF / Mascot", batsThrows: "R/R", image: "/gallery/chulo.jpg" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A1A3F] to-[#07132F] text-white flex flex-col items-center px-6 pb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 w-full max-w-7xl">
        {roster.map((player, i) => (
          <Link
            key={i}
            href={`/roster/${player.name.toLowerCase()}`}
            className="block group cursor-pointer"
          >
            <div className="bg-[#10224F] border-2 border-[#D4AF37] rounded-xl p-4 shadow-lg text-center transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_15px_#FFD700]">
              
              {/* Player Image Wrapper */}
              <div className="relative w-36 h-36 mx-auto mb-4 rounded-full border-2 border-[#D4AF37] overflow-hidden flex items-center justify-center bg-[#0A1A3F] card-glow">
                <Image
                ...
                />
                {/* Hover Overlay (no tap blocking) */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#D4AF37]/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-end pb-2 pointer-events-none">
